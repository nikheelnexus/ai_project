...
from company_ai_project_old.ui.company_ui.qdarktheme._style_loader import load_palette, load_stylesheet
...
def _apply_style(app, additional_qss: str | None, **kargs) -> None:
    from company_ai_project_old.ui.company_ui.qdarktheme._proxy_style import QDarkThemeStyle
...
def _sync_theme_with_system(app, callback) -> None:
    from company_ai_project_old.ui.company_ui.qdarktheme._os_appearance import listener
...
def enable_hi_dpi() -> None:
    ...
    """
    from company_ai_project_old.ui.company_ui.qdarktheme.qtpy.QtCore import Qt
    from company_ai_project_old.ui.company_ui.qdarktheme.qtpy.QtGui import QGuiApplication
...
def stop_sync() -> None:
    ...
    from company_ai_project_old.ui.company_ui.qdarktheme.qtpy.QtCore import QCoreApplication
