...
__version__ = "2.1.0"
# In your user_widget.py, replace the qdarktheme import with a try-catch block:


from company_ai_project_old.ui.company_ui.qdarktheme._main import enable_hi_dpi, setup_theme, stop_sync
from company_ai_project_old.ui.company_ui.qdarktheme._style_loader import clear_cache, get_themes, load_palette, \
    load_stylesheet
